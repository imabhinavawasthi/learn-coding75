...
import { FaJsSquare, FaCode, FaRocket } from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-white relative px-6 py-12 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="z-10 text-center max-w-4xl">
        <div className="flex justify-center mb-4 text-yellow-400 text-6xl">
          <FaJsSquare />
        </div>
  ...
  console.log("Hello, JavaScript World!");
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-gray-300">
          <div className="bg-[#1a1a1a] p-4 rounded-lg border border-yellow-500/30 flex flex-col items-center">
            <FaCode className="text-yellow-400 text-2xl mb-2" />
          ...
          <div className="bg-[#1a1a1a] p-4 rounded-lg border border-yellow-500/30 flex flex-col items-center">
            <FaJsSquare className="text-yellow-300 text-2xl mb-2" />
            <p>DOM Manipulation</p>
          </div>
        </div>

        {/* CTA Button */}
        <button className="mt-12 px-8 py-3 bg-gradient-to-r from-yellow-500 to-purple-600 hover:scale-105 transition-all duration-300 text-white font-bold rounded-full shadow-lg" onClick={() => router.push('/javascript/js-basics/introduction')}>
