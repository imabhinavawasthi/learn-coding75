...
ES6 or ECMAScript 2015 is the 6th version of the ECMAScript programming language. ECMAScript is the standardization of JavaScript, released in 2015 and subsequently renamed ECMAScript 2015.
...
- **Binary and Octal Literals**: Work with binary (`0b`) and octal (`0o`) numbers.
